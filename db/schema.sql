...
INSERT INTO 
    watches (name, image_url, price, description, user_id)
    VALUES ('Meteor Dove in Black Marble', 'https://alabaster.industries/cdn/shop/files/Dec_Allprod_Onblack_0006_AllprodOblack_0003_Layer7.jpg?v=1701833795', 4216.00, 'Descript,ion''s 1', 1);

INSERT INTO 
    watches (name, image_url, price, description, user_id)
    VALUES ('Silver Sinew in Blue Agate', 'https://alabaster.industries/cdn/shop/files/Dec_Allprod_Onblack_0008_AllprodOblack_0001_Layer9.jpg?v=1701834124', 3981.00, 'Description 2', 2);

INSERT INTO 
    watches (name, image_url, price, description, user_id)
    VALUES ('Gold Core in Eroded Gold', 'https://alabaster.industries/cdn/shop/files/Dec_Allprod_Onblack_0002_AllprodOblack_0007_Layer3.jpg?v=1701833882', 5933.00, 'Description 3', 3);
